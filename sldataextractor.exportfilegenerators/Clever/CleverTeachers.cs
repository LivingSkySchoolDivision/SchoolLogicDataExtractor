...
{
    public class CleverTeachers : ExportFileGenerator, IExportFileGenerator
    {
        ...
        public CleverTeachers(ConfigFile ConfigFile, Dictionary<string, string> Arguments) : base(ConfigFile, Arguments) { }
