...
{
    public class ClevrStudentDemographics : IExportFileGenerator
    {
        ...
        public ClevrStudentDemographics(ConfigFile ConfigFile, Dictionary<string, string> Arguments)
        {
        ...
        public MemoryStream GenerateCSV()
        {
            ...
            {
                writer.Write(stringContainer + _clevrTenantID + "" + stringContainer + delimiter);
