...
{
    public class ClevrStudentDemographics : ExportFileGenerator, IExportFileGenerator
    {
        private const char delimiter = '\t';
        private const string stringContainer = "";

        public ClevrStudentDemographics(ConfigFile ConfigFile, Dictionary<string, string> Arguments) : base(ConfigFile, Arguments) { }
        ...
        public MemoryStream Generate()
        {
            ...
            {
                writer.Write(stringContainer + _configFile.ClevrTenantID + "" + stringContainer + delimiter);
